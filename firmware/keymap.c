...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_5x6(
        ...
        KC_LCTL, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,                   KC_N   , KC_M   , KC_COMM, KC_DOT, KC_SLSH, KC_BSLS,
                          KC_LBRC, KC_RBRC,                                                       KC_MINS, KC_EQL,
                                            ...
                                            KC_LGUI, KC_LALT,                   KC_RSFT, KC_BSPC,
                                            KC_BSPC, KC_LSFT,                   KC_RCTL, KC_RALT
        ),
    ...
    [_L1] = LAYOUT_5x6(
          ...
          RGB_MOD, KC_LEFT, KC_LEFT, KC_DOWN, KC_RGHT, KC_LPRN,                 KC_RPRN, KC_4   , KC_5   , KC_6   , _______ , KC_VOLU ,
          RGB_VAI, RGB_VAD, _______, _______, _______, _______,                 _______, KC_1   , KC_2   , KC_3   , _______ , KC_VOLD ,
    ...
    [_L2] = LAYOUT_5x6(
        ...
        TOG_GAM, _______, _______, KC_UP  , _______, RGB_HUI,                 KC_RBRC, _______, KC_UP  , KC_INS , KC_SCRL, KC_MUTE,
        RGB_MOD, KC_LEFT, KC_LEFT, KC_DOWN, KC_RGHT, RGB_SAI,                 KC_RPRN, KC_LEFT, KC_DOWN, KC_RGHT, _______, KC_VOLU,
        _______, _______, _______, _______, _______, RGB_VAI,                 _______, _______, _______, _______, _______, KC_VOLD,
